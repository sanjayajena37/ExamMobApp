package com.nirmalya.governmentexams.repository;

import android.content.Context;
import android.widget.Toast;

import com.nirmalya.governmentexams.Opsc;
import com.nirmalya.governmentexams.model.responce.StudentResponse;
import com.nirmalya.governmentexams.network.ApiInterface;
import com.nirmalya.governmentexams.network.ApiManager;
...
public class APIRepo {
    ...
    public APIRepo() {
        context = Opsc.getInstance().getApplicationContext();
    }
